...
install_V2bX() {
    ...
    file="https://github.com/Hadia-pixel/V2bX-script/raw/master/V2bX.service"
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/Hadia-pixel/V2bX-script/master/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/Hadia-pixel/V2bX-script/master/initconfig.sh
